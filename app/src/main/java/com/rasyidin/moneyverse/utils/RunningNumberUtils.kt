...
object RunningNumberUtils {
    ...
    fun getIdTransactionOutcome(): String {
    ...
    fun getIdTransactionIncome(): String {
    ...
    fun getIdTransactionTransfer(): String {
        var lastRunningNumber = Prefs.getString(PrefKey.TRANSACTION_TRANSFER)
        lastRunningNumber = generateRunningNumber(lastRunningNumber)
